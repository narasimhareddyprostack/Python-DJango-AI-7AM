...
""" 
'''
API USAGE: fetch all products
API URL: http://127.0.0.1:8000/products
Method :GET
...
@app.get('/products')
def get_products():
    print("Inside - get Products function")
    return products


 """
'''
API USAGE: fetch product by id
API URL: http://127.0.0.1:8000/products/2
Method :GET
Required Fields:None
Access Type:Public
'''
@app.get('/products/{prod_id}')
def get_products(prod_id:int):
    print(prod_id)
...
'''
API USAGE: feach products based on categroy - filtering based on result
API URL: http://127.0.0.1:8000/products?category=beauty
Method :GET
Required Fields:None
Access Type:Public
'''
@app.get("/products")
def get_product_by_category(category:Optional[str]=None):
    print("Inside - get Products by category function")
    print(category)
